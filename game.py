...
import time
import random
word_library = [ "close", "obstacle", "relinquish", "photography", "past", "responsible", "descent", "list", "cathedral", "dollar", "spray", "laundry", "cancer", "implicit", "helmet", "eternal", "index", "picture", "decoration", "communist", "percent", "result", "mechanism", "depart", "thesis", "indulge", "hell", "asset", "player", "volume", "scan", "middle", "wrong", "estimate", "master", "session", "shrink", "deprive", "baby", "shout", "canvas", "swarm", "astonishing", "flesh", "include", "foreigner", "van", "widen", "concert", "adopt", "license", "stride", "cold", "dirty", "detail", "uncertainty", "forecast", "wall", "breathe", "eagle", "bucket", "capture", "boy", "fisherman", "mushroom", "injury", "tasty", "spit", "radio", "fixture", "hesitate", "cause", "tempt", "collect", "self", "vein", "flag", "entry", "neck", "snack", "feather", "state", "match", "border", "step", "photograph", "eternal", "grave", "curve", "mix", "pedestrian", "clothes", "trunk", "nun", "familiar", "conviction"]
class typing_test():
    class char():
